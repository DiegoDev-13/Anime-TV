  ...
  return (
    <div className="w-[60%]">
        <form className="relative flex justify-center items-center space-x-4" onSubmit={handleSubmit}>
            ...
            <input type="search" placeholder="Buscar anime favorito" value={searchTerm} onChange={e => setsearchTerm(e.target.value)} className="text-stone-200 bg-surface-dark pl-10 py-2 px-3 w-full rounded-3xl outline-none"/>
