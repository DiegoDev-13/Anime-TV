  ...
  return (
    <div className="w-full flex flex-col items-center relative">
      <div className="w-full h-50 md:h-80 md:max-h-100">
        <img src={user?.imagen_banner} alt="" className="w-full h-full rounded-4xl"/>
      </div>
      <div className="flex flex-col md:flex-row w-full justify-around items-center absolute md:bottom-10 md:left-0 mt-2 md:mt-0">
        <div className="flex flex-col justify-center items-center md:flex-row">
          ...
          <div className="ml-4">
            ...
            <p className="text-sm w-[80%] md:w-ful text-stone-300 text-center md:text-left ">{user.description}</p>
          </div>  
        </div>
        <div className="">
