  ...
  return (
    <div className="w-full flex flex-col items-center relative">
      <div className="w-full h-50 md:h-auto md:max-h-100">
        <img src="https://t4.ftcdn.net/jpg/04/04/73/39/360_F_404733910_2mIXr6RbC5G3WZJFjopVsBaR3EOM6Bqy.jpg" alt="" className="w-full h-full rounded-4xl object-contai"/>
      </div>
      <div className="flex flex-col md:flex-row w-full justify-around items-center absolute md:bottom-10 md:left-0">
        ...
        <div className="">
          <button className="py-2 px-4 bg-surface-dark text-white rounded-3xl flex items-center gap-1 cursor-pointer font-medium">
            <MdEdit size={20} />
            Editar Perfil
          </button>
        </div>
