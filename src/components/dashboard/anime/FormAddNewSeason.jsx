...
export const FormAddNewSeason = ({idAnimeSelected}) => {
  ...
  return (
    <>
        ...
        <form onSubmit={hnadleSubmit} className="w-full flex justify-between mb-6">
            ...
            <div className="w-[60%] p-5 bg-surface-dark border border-stone-700 rounded-lg">
                ...
                <div className="flex flex-col">
                    ...
                    <input type="text" id="title" autoComplete="off" placeholder="Ingresa el titulo de la temporada" className="p-2 mt-2 text-stone-200 bg-surface-dark-highlight border border-stone-700 rounded-lg outline-none focus:border-purple-700 transition-all duration-300" value={inputTitle} onChange={(e) => setInputTitle(e.target.value)}/>
                </div>

                <div className="flex justify-between my-4 w-full">
                    <div className="flex flex-col w-[30%]">
                        <label htmlFor="numberSeason" className="text-stone-300 text-[16px] font-semibold">Numero de temporada</label>
                        <input type="number" id="numberSeason" min='1' max="50" step="1" className="p-2 mt-2 text-stone-400 bg-surface-dark-highlight border border-stone-700 rounded-lg outline-none focus:border-purple-700 transition-all duration-300" />
                    </div>
                    <div className="flex flex-col w-[30%]">
                        <label htmlFor="yearSeason" className="text-stone-300 text-[16px] font-semibold">Año de temporada</label>
                        <input type="number" id="yearSeason" min="1990" max="2099" step="1" placeholder="Año de publicacion" className="p-2 mt-2 text-stone-200 bg-surface-dark-highlight border border-stone-700 rounded-lg outline-none focus:border-purple-700 transition-all duration-300" />
                    </div>
                ...
                <div className="flex justify-between my-4 w-full">
                    <div className="flex flex-col w-[30%]">
                        ...
                        <select id="status" className="p-2 mt-2 text-stone-200 bg-surface-dark-highlight border border-stone-700 rounded-lg font-semibold" value={seasonStatus} onChange={(e) => handleChangeStatus(e)}>
                    ...
                    <div className="flex flex-col w-[30%]">
                        ...
                        <input type="number" id="rating" min="0" max="10" step="0.1" placeholder="Año de publicacion" className="p-2 mt-2 text-stone-200 bg-surface-dark-highlight border border-stone-700 rounded-lg outline-none focus:border-purple-700 transition-all duration-300" />
                    </div>
                    <div className="flex flex-col w-[30%]">
                        <label htmlFor="studyAnimation" className="text-stone-300 text-[16px] font-semibold">Estudio de animación</label>
                        <input type="text" id="studyAnimation" className="p-2 mt-2 text-stone-400 bg-surface-dark-highlight border border-stone-700 rounded-lg outline-none focus:border-purple-700 transition-all duration-300"/>
                    </div>
                </div>
                <div className="w-full">
                        <label htmlFor="studyAnimation" className="text-stone-300 text-[16px] font-semibold">Descripción</label>
                        <textarea className="w-full max-h-80 min-h-30 p-4 bg-surface-dark-highlight text-stone-300 rounded-lg border border-stone-700 outline-none focus:border-purple-700 transition-all duration-300" rows="7" cols="20" maxLength={800} id placeholder="Escribe una descripción del anime" ></textarea>
                </div>
