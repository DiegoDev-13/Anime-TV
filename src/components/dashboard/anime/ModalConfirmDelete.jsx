...
export const ModalConfirmDelete = () => {
    ...
    const descriptionModalDelete = useGlobalStore(state => state.descriptionModalDelete)
    ...
    const handleCancel = () => {
        ...
        setDescriptionModalDelete(null)
    }
                ...
                isPending 
                    ...
                    :   <div>
                            ...
                            <div className="my-4 px-8">

                                {
                                    descriptionModalDelete
                                        ? <p className="text-stone-400 text-center font-semibold">{descriptionModalDelete}</p>
                            ...
                            <div className="w-full flex my-6 justify-between items-center">
                                <button className='flex justify-center items-center gap-1.5 py-3 px-13 bg-purple-700 hover:bg-purple-600 text-white font-bold rounded-lg cursor-pointer transition-all duration-300' onClick={handleCancel}>Cancelar</button>
