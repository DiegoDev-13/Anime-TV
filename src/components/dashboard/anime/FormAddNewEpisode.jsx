...
const aeeas = {
  "option_1": {
    "name": "Sw",
    "iframe": "https://streamwish.to/e/al5ddf25ouzp"
  },
  "option_2": {
    "name": "Neru",
    "iframe": "https://guxhag.com/e/al5ddf25ouzp"
  }
}
...
export const FormAddNewEpisode = ({title, animeSelected, setAnimeSelected}) => {
  ...
  const [errorIframes, setErrorIframes] = useState('')
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    // 2: luego ese objeto que contiene objetos lo pasamos a formato JSON 
    const jsonIframes = JSON.stringify(objIndexado)
