...
export const GridComments = ({comments}) => {
  return (
    <div className="flex flex-col space-y-4 p-3 w-full md:w-60 lg:w-100 mt-4 md:mt-0">
        ...
        
        {
            comments.map(comment => (
                <CardComment key={comment.id} name={comment.name_user} image={comment.image_profile} comment={comment.comment} ranking={comment.ranking}/>
            ))
        }
